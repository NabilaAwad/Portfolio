...
export default function Hero() {
  ...
  download
  className="bg-blue-600 text-white px-7 py-3 rounded-xl"
>
  Download CV
</a>
       ...
       <a
  href="#Contact"
  className="bg-blue-600 flex items-center text-white px-7 py-3 gap-2 rounded-xl"
>
